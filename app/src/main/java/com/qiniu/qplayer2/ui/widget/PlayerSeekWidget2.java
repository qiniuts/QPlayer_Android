...
public class PlayerSeekWidget2 extends AppCompatTextView {
    private PlayerBiteRateVM mPlayerBiteRateVM=new PlayerBiteRateVM();
    private Observer<Long> mObserver= it -> setText((it/1024)+"kbps");

    public PlayerSeekWidget2(@NonNull Context context) {
        super(context);
    }

    public PlayerSeekWidget2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PlayerSeekWidget2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
